...
void UOTIdentitySubsystem::LoginWithCredentials(FString CredentialsType, FString CredentialsToken, FString CredentialsId)
{
	checkf(IdentityInterface != nullptr, TEXT("Unable to get the Identity interface"));

	FOnlineAccountCredentials Credentials;
	Credentials.Type = CredentialsType; // "Developer";
	Credentials.Token = CredentialsToken; // "GameDev";
	Credentials.Id = CredentialsId; // "localhost:8080";
